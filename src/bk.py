...
class BlastForum:
    ...
    def _get_links(self, pattern: str, page_html: str):
        try:
    ...
    def get_heading_link(self, heading:str, page_html: str):
        ...
        return self._get_links(pattern, page_html);

    def get_topic_links(self, page_html: str ):
        pattern = r'<a href=\"(/threads/\d+/)\" class='
        return self._get_links(pattern, page_html)[0:5];
    ...
    def get_words(self, text: str):
        ...
        return self._get_links(pattern, text);